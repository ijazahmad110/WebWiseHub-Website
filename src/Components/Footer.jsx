...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-white bg-[#C51E3A]'>
      <div>
        <h1 className='w-full text-3xl font-bold text-black'>WebWiseHub</h1>
